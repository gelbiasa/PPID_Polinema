            ...
            @foreach($notifikasi as $item)
                <div class="p-3 mb-3 notifikasi-item {{ $item->sudah_dibaca ? 'notifikasi-dibaca' : '' }}"
                    ...
                    <div style="flex: 1;">
                        ...
                        <p style="margin: 0;">Status pemohon: {{ $item->t_permohonan->status_pemohon ?? 'Data Sudah Dihapus' }}
                        </p>
                    ...
                    <div style="display: flex; flex-direction: column; align-items: flex-end;">
                        <!-- Tombol Hapus -->
                        <button class="btn btn-danger btn-sm hapus-notifikasi" data-id="{{ $item->notifikasi_adm_id }}"
