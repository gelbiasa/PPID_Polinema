...
$jumlahNotifikasiPermohonan = NotifikasiAdminModel::where('kategori', 'permohonan')
    ->whereNull('sudah_dibaca')
    ->whereNull('deleted_at')
    ->count();

// Hitung jumlah notifikasi untuk kategori 'pertanyaan'
$jumlahNotifikasiPertanyaan = NotifikasiAdminModel::where('kategori', 'pertanyaan')
    ->whereNull('sudah_dibaca')
    ->whereNull('deleted_at')
    ->count();
?>
...
<div class="card">
    ...
    <div class="card-body" style="padding-top: 10px;">
        <div class="row text-center">
            <!-- Permohonan -->
            <div class="col-md-6">
                <a href="{{ url('notifAdmin/notif_permohonan') }}" class="custom-button d-block p-3 mb-2 position-relative">
            ...
            <!-- Pertanyaan -->
            <div class="col-md-6">
                <a href="{{ url('notifAdmin/notif_pertanyaan') }}" class="custom-button d-block p-3 mb-2 position-relative">
