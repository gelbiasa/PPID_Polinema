            ...
            @foreach($notifikasi as $item)
                <div class="p-3 mb-3 notifikasi-item {{ $item->sudah_dibaca ? 'notifikasi-dibaca' : '' }}"
                    ...
                    <div style="flex: 1;">
                        ...
                        <p style="margin: 0;">Status pemohon:
                            {{ $item->t_pertanyaan_lanjut->status_pemohon ?? 'Data Sudah Dihapus' }}</p>
                        <p style="margin: 0;">Kategori: {{ $item->t_pertanyaan_lanjut->kategori ?? 'Data Sudah Dihapus' }}</p>
                    ...
                    <div style="display: flex; flex-direction: column; align-items: flex-end;">
                        <!-- Tombol Hapus -->
                        <button class="btn btn-danger btn-sm hapus-notifikasi" data-id="{{ $item->notifikasi_mpu_id }}"
                            style="width: 132px;">
                            Hapus
                        </button>
