...
<div class="card">
    ...
    <div class="row text-center">
        <!-- Akademis -->
        <div class="col-md-4">
            <a href="{{ url('pengajuanPertanyaan/daftarAkademik') }}" class="custom-button d-block p-3 mb-2">
        ...
        <!-- Layanan -->
        <div class="col-md-4">
            <a href="{{ url('pengajuanPertanyaan/daftarLayanan') }}" class="custom-button d-block p-3 mb-2">
        ...
        <!-- Teknis -->
        <div class="col-md-4">
            <a href="{{ url('pengajuanPertanyaan/daftarTeknis') }}" class="custom-button d-block p-3 mb-2">
