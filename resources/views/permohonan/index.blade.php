...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Prosedur Pengajuan Permohonan</h3>
    </div>
    <div class="card-body" style="margin-bottom: 0; padding-bottom: 0;">
        ...
        <ol style="margin-bottom: 0;">
            <li>Pilih Kategori Pengajuan Permohonan</li>
    ...
    <div class="card-body" style="padding-top: 10px;">
        <hr class="thick-line">
        <h4><strong>Kategori Permohonan:</strong></h4>
        <hr class="thick-line">
        <div class="row text-center">
            <!-- Akademis -->
            <div class="col-md-4">
                <a href="{{ url('permohonan/formAkademik') }}" class="custom-button d-block p-3 mb-2">
            ...
            <!-- Layanan -->
            <div class="col-md-4">
                <a href="{{ url('permohonan/formLayanan') }}" class="custom-button d-block p-3 mb-2">
            ...
            <!-- Teknis -->
            <div class="col-md-4">
                <a href="{{ url('permohonan/formTeknis') }}" class="custom-button d-block p-3 mb-2">
