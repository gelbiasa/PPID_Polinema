...
$jumlahDaftarAkademik = PermohonanLanjutModel::where('kategori', 'Akademik')
    ->where('status', 'Diproses')
    ->count();

$jumlahDaftarLayanan = PermohonanLanjutModel::where('kategori', 'Layanan')
    ->where('status', 'Diproses')
    ->count();

$jumlahDaftarTeknis = PermohonanLanjutModel::where('kategori', 'Teknis')
    ->where('status', 'Diproses')
    ->count();
?>
...
<div class="card">
    ...
    <div class="row text-center">
        <!-- Akademis -->
        <div class="col-md-4">
            <a href="{{ url('pengajuanPermohonan/daftarAkademik') }}" class="custom-button d-block p-3 mb-2">
        ...
        <!-- Layanan -->
        <div class="col-md-4">
            <a href="{{ url('pengajuanPermohonan/daftarLayanan') }}" class="custom-button d-block p-3 mb-2">
        ...
        <!-- Teknis -->
        <div class="col-md-4">
            <a href="{{ url('pengajuanPermohonan/daftarTeknis') }}" class="custom-button d-block p-3 mb-2">
