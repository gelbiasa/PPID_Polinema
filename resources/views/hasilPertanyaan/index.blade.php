...
<div class="card">
    ...
    <div class="row text-center">
        <!-- Akademis -->
        <div class="col-md-4">
            <a href="{{ url('hasilPertanyaan/daftarAkademik') }}" class="custom-button d-block p-3 mb-2">
        ...
        <!-- Layanan -->
        <div class="col-md-4">
            <a href="{{ url('hasilPertanyaan/daftarLayanan') }}" class="custom-button d-block p-3 mb-2">
        ...
        <!-- Teknis -->
        <div class="col-md-4">
            <a href="{{ url('hasilPertanyaan/daftarTeknis') }}" class="custom-button d-block p-3 mb-2">
